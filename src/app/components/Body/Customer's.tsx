...
export default function Customer() {
  return (
    <div className="bg-[#f0f4f7] w-[100vw] md:px-[150px] md:py-[55px] p-[28px] md:gap-20 gap-6 flex items-center justify-center md:flex-row flex-col">
      ...
      <div className="flex flex-col items-center justify-evenly gap-7 md:h-auto text-[#717171]">
        <div className="flex flex-col justify-evenly gap-3">
          <p className="text-[0.9rem] md:text-[1rem] text-justify font-medium">
        ...
        <div className="flex flex-col relative right-3 md:flex-row w-full justify-evenly gap-8 md:gap-6 ">
          <div className="flex justify-evenly gap-3 md:gap-8 md:w-[70%] w-full overflow-x-auto scrollbar-hide">
            {Array(clientsWebSites.length)
              ...
              .map((_, i) => (
                <Image
                  ...
                  height={48}
                  key={i}
                  className="h-[3rem] md:mx-[0.6rem] mx-[0.1rem] md:h-[3.4rem] "
